<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="#"><i class="fas fa-envelope"></i>CleanSkincare@gmail.com</a>
         <a href="#"><i class="fas fa-map-marker-alt"></i> Bandung, indonesia - 666 </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>CleanSkin</span> | all rights reserved!</div>

...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex">
      <div class="price">Rp <?= number_format($fetch_cart['price'], 3, ',', '.'); ?>,-</div>

         <input type="number" name="qty" class="qty" min="1" max="99" onkeypress="if(this.value.length == 2) return false;" value="<?= $fetch_cart['quantity']; ?>">
         <button type="submit" class="fas fa-edit" name="update_qty"></button>
      </div>
      <div class="sub-total"> sub total : <span>Rp <?= number_format($sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']), 3, ',', '.'); ?>,-</span> </div>
   ...
   <div class="cart-total">
      <p>Total : <span>Rp <?= number_format($grand_total, 3, ',', '.'); ?>,-</span></p>
